export const registry = [
  {
    inputs: [{ internalType: "address", name: "_transactionToken", type: "address" }],
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: true, internalType: "address", name: "affiliateAddress", type: "address" },
      { indexed: false, internalType: "string", name: "affiliateName", type: "string" },
      { indexed: false, internalType: "uint256", name: "numberOfSales", type: "uint256" },
      { indexed: false, internalType: "uint256", name: "totalEarned", type: "uint256" },
    ],
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: "uint16", name: "comission", type: "uint16" },
      { indexed: false, internalType: "uint16", name: "stock", type: "uint16" },
      { indexed: false, internalType: "uint128", name: "maxFID", type: "uint128" },
      { indexed: false, internalType: "uint128", name: "minFollowers", type: "uint128" },
      { indexed: false, internalType: "uint128", name: "minPostsLastWeek", type: "uint128" },
      { indexed: false, internalType: "string", name: "permalink", type: "string" },
      { indexed: false, internalType: "string", name: "productImage", type: "string" },
      { indexed: false, internalType: "address", name: "receiptAddress", type: "address" },
      { indexed: false, internalType: "enum IRegistry.CampaignStatus", name: "status", type: "uint8" },
    ],
  ...
  },
  {
    ...
    inputs: [
      { indexed: false, internalType: "uint256", name: "id", type: "uint256" },
      { indexed: false, internalType: "address", name: "merchantAddress", type: "address" },
      { indexed: false, internalType: "string", name: "merchantName", type: "string" },
      { indexed: false, internalType: "uint256", name: "numberOfSales", type: "uint256" },
      { indexed: false, internalType: "uint256", name: "totalEarned", type: "uint256" },
    ],
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: "bytes32", name: "buyerHash", type: "bytes32" },
      { indexed: false, internalType: "uint256", name: "affiliateFID", type: "uint256" },
      { indexed: false, internalType: "uint256", name: "price", type: "uint256" },
      { indexed: false, internalType: "uint256", name: "comission", type: "uint256" },
      { indexed: false, internalType: "enum IRegistry.OrderStatus", name: "status", type: "uint8" },
    ],
    name: "CreatedOrder",
    type: "event",
  },
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: "enum IRegistry.CampaignStatus", name: "status", type: "uint8" },
    ],
    stateMutability: "view",
    type: "function",
  },
    ...
    outputs: [
      {
        components: [
          ...
          { internalType: "bytes32", name: "buyerHash", type: "bytes32" },
          { internalType: "enum IRegistry.OrderStatus", name: "status", type: "uint8" },
        ],
  ...
  {
    inputs: [{ internalType: "uint256", name: "affiliateFID", type: "uint256" }],
