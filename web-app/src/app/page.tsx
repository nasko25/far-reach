    ...
    <>
      ...
      <div>
        ...
        <div className="flex justify-center space-x-4 max-w-screen-sm mx-auto py-4">
          <button className="px-6 py-2 bg-[#96bf48] text-white hover:bg-[#7a9e38] transition duration-300 rounded-lg">
            Find Affiliates
          </button>
          <button className="px-6 py-2 bg-[#8A63D2] text-white hover:bg-purple-700 transition duration-300 rounded-lg">
